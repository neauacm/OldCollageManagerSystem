...
<body>
	...
	<div class="form_content">
		<h1 align="center"  color:#FFFFFF> 学生登陆</h1> 
		
   <form action="Register_for_student_servlet" method="post">
    <fieldset>
        <legend>登录信息</legend>
      ...
      <div class="form-row">
            <div class="field-label"><label for="field2">学号</label>:</div>
    ...
    <fieldset>
        ...
        <div class="form-row">
            <div class="field-label"><label for="field1">学员身份</label>:</div>
            <div class="field-widget">
         <input name = "shenfen" type="radio"  id="field1"  value="干部"  />干部
  		 <input name = "shenfen"  id="field1" type="radio"value="非干部"  />非干部</br></div>
        </div>
